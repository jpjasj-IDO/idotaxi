    ...
    <div ref={containerRef} className="relative w-full min-h-[720px] max-h-screen flex items-center justify-center px-4 py-28 md:py-32 overflow-hidden bg-transparent">
      ...
      <div ref={innerRef} className="relative z-10 w-full max-w-[760px] mx-auto flex flex-col items-center text-center">
        ...
        <div className="reveal-stagger flex flex-col sm:flex-row items-center justify-center gap-3 mb-14 w-full sm:w-auto">
          <a className="btn-primary w-full sm:w-auto justify-center" href="https://wa.me/9613593596" target="_blank" rel="noopener noreferrer">
            <span className="relative z-10 flex items-center">
              <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor" className="mr-2">
          ...
          <a className="btn-ghost w-full sm:w-auto justify-center" href="tel:+9613593596">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
              <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.37 1.9.72 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.91.35 1.85.59 2.81.72A2 2 0 0 1 22 16.92z" />
            </svg>
            <span>Call Us</span>
          </a>
          <a className="btn-ghost w-full sm:w-auto justify-center" href="https://tosto.re/idotaxi" target="_blank" rel="noopener noreferrer">
